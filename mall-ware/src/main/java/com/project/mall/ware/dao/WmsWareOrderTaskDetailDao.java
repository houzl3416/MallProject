...
public interface WmsWareOrderTaskDetailDao {
     ...
     * @return 对象列表
     */
    List<WmsWareOrderTaskDetail> queryAllByLimit(WmsWareOrderTaskDetail wmsWareOrderTaskDetail, @Param("pageable") Pageable pageable);
     ...
     * @return 总行数
     */
    long count(WmsWareOrderTaskDetail wmsWareOrderTaskDetail);
