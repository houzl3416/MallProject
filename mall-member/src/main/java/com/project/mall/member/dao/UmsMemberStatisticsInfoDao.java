...
public interface UmsMemberStatisticsInfoDao {
     ...
     * @return 对象列表
     */
    List<UmsMemberStatisticsInfo> queryAllByLimit(UmsMemberStatisticsInfo umsMemberStatisticsInfo, @Param("pageable") Pageable pageable);
     ...
     * @return 总行数
     */
    long count(UmsMemberStatisticsInfo umsMemberStatisticsInfo);
