...
public interface SmsHomeSubjectSpuDao {
     ...
     * @return 对象列表
     */
    List<SmsHomeSubjectSpu> queryAllByLimit(SmsHomeSubjectSpu smsHomeSubjectSpu, @Param("pageable") Pageable pageable);
     ...
     * @return 总行数
     */
    long count(SmsHomeSubjectSpu smsHomeSubjectSpu);
